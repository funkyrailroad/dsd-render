...
- Push these changes to Render.
- Open your deployed project in a new browser tab.
"""

cancel_render = """
Okay, cancelling Render configuration and deployment.
"""
...
def success_msg_automate_all(deployed_url):
    ...
    msg = dedent(
        ...
        --- Your project should now be deployed on Render ---
        ...
        If you make further changes and want to push them to Render,
